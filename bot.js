...
client.user.setGame(`Blue Codes.™`,"https://www.twitch.tv/S-F")
  console.log('')
  console.log('')
  console.log('╔[═════════════════════════════════════════════════════════════════]╗')
            ...
            message.channel.awaitMessages(filter, { max: 1, time: 3000000, errors: ['time'] }).then(collected => {
                ...
                msgS.edit(':timer: | **ما خبرتك ؟**').then(msgS => {
                    message.channel.awaitMessages(filter, { max: 1, time: 3000000, errors: ['time'] }).then(collected => {
                        ...
                        collected.first().delete();
                        msgS.edit(':timer: | **وش الفرق بين const و var**').then(msgS => {
                            message.channel.awaitMessages(filter, { max: 1, time: 3000000, errors: ['time'] }).then(collected => {
                                fromwhere = collected.first().content;
                                collected.first().delete();
                                msgS.edit(':timer: | **لماذا تريد التقديم ؟**').then(msgS => {
                                    message.channel.awaitMessages(filter, { max: 1, time: 3000000, errors: ['time'] }).then(collected => {
                                        ...
                                        .addField('سبب تقديمو على الرتبة', fa2dh, true)
                                        .setTimestamp()
                                        .setFooter(message.guild.name, message.guild.iconURL)
